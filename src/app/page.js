...
const IconChevronLeft = () => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 19.5L8.25 12l7.5-7.5" /></svg>);
const IconChevronRight = () => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" d="M8.25 4.5l7.5 7.5-7.5 7.5" /></svg>);

// Loading Spinner Component
const LoadingSpinner = () => (
  <div className="flex justify-center items-center py-8" role="status" aria-label="Đang tải dữ liệu">
...
const ErrorMessage = ({ error, onRetry }) => (
  <div className="text-center py-8" role="alert" aria-live="assertive">
    ...
    <p className="text-gray-500 mb-4">{error || 'Không thể tải dữ liệu. Vui lòng thử lại.'}</p>
    <button
      onClick={onRetry}
          ...
          <div className="bg-white rounded-2xl border border-slate-100 shadow-sm">
            ...
            <div className="px-6 py-4 border-b border-slate-100 flex flex-col sm:flex-row gap-3">
              <div className="relative flex-1">
                <label htmlFor="search-input" className="sr-only">Tìm kiếm sách</label>
                <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
                ...
                />
                <span id="search-help" className="sr-only">Nhập tên sách hoặc tác giả để tìm kiếm</span>
              </div>
              <div>
                <label htmlFor="category-select" className="sr-only">Lọc theo thể loại</label>
                <select
                  id="category-select"
                ...
                <span id="category-help" className="sr-only">Chọn thể loại sách để lọc</span>
              </div>
              <div>
                <label htmlFor="year-select" className="sr-only">Lọc theo năm xuất bản</label>
                <select
                  id="year-select"
                  value={filterYear}
                ...
                <span id="year-help" className="sr-only">Chọn năm xuất bản để lọc</span>
              </div>
              {hasActiveFilter && (
                <button
